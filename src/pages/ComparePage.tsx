...
function Column({
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 dark:bg-gray-900/60 dark:border-gray-800 rounded-2xl p-5 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">{title}</h2>
          <p className="text-xs text-gray-500 dark:text-gray-600 mt-0.5">{movies.length} фильмов</p>
        </div>
        <button
...
export default function ComparePage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8">Сравнение</h1>
